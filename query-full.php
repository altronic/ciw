...
<?php
 ...
 //   $SEARCH_PATH = "data/pricemulti";
    $SEARCH_PATH = "data/pricemultifull";
...
//            echo "=====".$url."=====";
    ...
    function coinsearch($coins,$currencies) {
        ...
        function crypto_api($coins, $currencies,$exist) {
            ...
            // below foreach works to show the key names of primary object decoded from Yelp response (REGION, BUSINESSES, and TOTAL)
                ...
                if ($key0 == "DISPLAY") {
                    ...
                    foreach($value0 as $key1 => $value1)
                    {
                        ...
                        echo '<b> '.$key1.'</b>';
                        if ($exist=="yes"){
                          echo '<div class="save_section"> (Saved) </div>';
                        }
                        else {
                          echo '<div id="save_section"><a href="javascript:addSymbol(\''.$key1.'\');">Save Symbol</a></div>';
                        }
                        ...
                        foreach ($value1 as $key2 => $value2) {
                            ...
                            foreach ($value2 as $key3 => $value3) {
                                if ($key2 == "USD" && $key3 == 'PRICE') {
                                  //echo ' '.$key3;
                                  echo "USD Price<br>";
                                  echo $value3;
                                  echo "<br>";
                                }
                                elseif ($key2 == "BTC" && $key3 == 'PRICE') {
                                  //echo ' '.$key3;
                                  echo "BTC Price<br>";
                                  echo $value3;
                                  echo "<br>";
                                }
                                elseif ($key2 == "BTC" && $key3 == 'IMAGEURL') {
                                  echo "<br>";
                                  echo '<img src="http://cryptocompare.com' . $value3 . '" width="80">';
                                  echo "<br>";
                                }
...
*/
    ...
    crypto_api($coins,$currencies,$exist);
?>
